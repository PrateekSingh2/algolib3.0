...
// ... (ParticleBackground, EliteBackground, CookieConsent, UnauthenticatedLanding omitted for brevity but remain identical to your original code) ...
// INCLUDING ALL YOUR EXISTING COMPONENTS BELOW TO ENSURE NO DATA LOSS
        ...
        <main className="relative z-10 w-full flex-1 flex flex-col items-center pb-16">
          <div className="text-center max-w-5xl mx-auto mt-16 md:mt-24 px-6 flex flex-col items-center relative z-20">
            ...
            <motion.div initial={{ opacity: 0, scale: 0.98 }} animate={{ opacity: 1, scale: 1 }} transition={{ delay: 0.3 }} className="relative w-full max-w-xs mx-auto mb-16">
              ...
              <button onClick={executeGoogleSignIn} className={`group relative inline-flex h-12 w-full items-center justify-center overflow-hidden rounded-full p-[1px] font-medium text-white transition-all duration-300 ${loginAlert ? 'ring-2 ring-white/20 ring-offset-2 ring-offset-black' : ''}`}>
          ...
          <div className="w-full max-w-2xl mx-auto text-center border-t border-white/[0.05] pt-24 px-6">
            ...
            <button onClick={executeGoogleSignIn} className="group inline-flex items-center gap-2 text-sm font-medium text-white bg-white/[0.03] hover:bg-white/[0.08] border border-white/[0.1] px-6 py-3 rounded-full transition-all">
...
const AuthGuard = ({ children }: { children: React.ReactNode }) => {
  ...
  const publicRoutes = ['/terms', '/privacy', '/cookies', '/developer', '/support', '/docs', '/compiler', '/visualizer'];
