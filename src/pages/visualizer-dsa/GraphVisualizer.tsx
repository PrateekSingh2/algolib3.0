...
const GraphVisualizer = () => {
  ...
  return (
    <div className="flex flex-col-reverse lg:flex-row-reverse gap-4 lg:gap-6 h-full w-full relative font-sans text-slate-900 dark:text-white lg:p-3 select-none">
      ...
      <div className="w-full lg:w-80 flex flex-col gap-4 shrink-0 flex-1 min-h-0 lg:flex-none overflow-y-auto custom-scrollbar lg:pr-2 pb-4 lg:pb-0">
        ...
        <div className="bg-white/60 backdrop-blur-xl dark:bg-[#0d1117] border border-slate-200 dark:border-[#30363d] rounded-2xl p-5 shadow-sm shrink-0 mt-auto">
            ...
            <div className="flex-1 min-h-[100px] lg:min-h-[150px] bg-slate-50 dark:bg-[#161b22] border border-purple-200 dark:border-[#30363d] rounded-xl flex flex-col overflow-hidden shadow-inner">
                <div className="px-3 py-2 border-b border-purple-200 dark:border-[#30363d] bg-purple-100 dark:bg-[#0d1117] flex items-center gap-2 shrink-0">
      ...
      <div className="h-[48vh] shrink-0 lg:h-auto lg:flex-1 bg-white/60 backdrop-blur-xl dark:bg-[#0d1117] border border-slate-200 dark:border-[#30363d] rounded-2xl p-4 sm:p-6 shadow-sm relative overflow-hidden flex flex-col">
          ...
          <div className="flex-1 min-h-0 border border-slate-200 dark:border-[#30363d] bg-white/60 backdrop-blur-xl/50 dark:bg-[#0a0c10] rounded-2xl relative flex flex-col shadow-inner overflow-hidden mb-2 lg:mb-4 w-full">
             ...
             <div className="absolute top-3 right-3 lg:top-4 lg:right-4 z-30 flex items-center gap-2 lg:gap-3 px-3 lg:px-4 py-1 lg:py-1.5 bg-white/90 dark:bg-[#0a0a14]/90 backdrop-blur-md border border-slate-200 dark:border-[#30363d] rounded-full shadow-lg pointer-events-none">
          ...
          <AnimatePresence initial={false}>
              {showHUD && (
                  ...
                  >
                     <div className="w-full h-full bg-slate-50 dark:bg-[#161b22] border border-slate-200 dark:border-[#30363d] rounded-xl flex flex-col shadow-inner overflow-hidden relative">
          ...
          >
            ...
            >
              ...
              <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-2 flex items-center gap-2">
                <Activity className="text-emerald-500" /> Graph Visualizer
              </h3>
              ...
              <div className="space-y-4 text-sm text-slate-600 dark:text-slate-300 mt-4 h-max overflow-y-auto max-h-[60vh] custom-scrollbar pr-2">
                <p>
                  A <strong>Graph</strong> is a non-linear data structure consisting of vertices (nodes) and edges (connections). They can be directed or undirected, weighted or unweighted.
                </p>
                <h4 className="font-bold text-slate-800 dark:text-slate-200 mt-4">Key Operations</h4>
                <p>
                  You can visualize traversal algorithms like <strong>BFS</strong> and <strong>DFS</strong>, or shortest path algorithms like <strong>Dijkstra</strong>.
                </p>
              </div>
            </motion.div>
          </motion.div>
