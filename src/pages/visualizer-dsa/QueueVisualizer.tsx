    ...
    <div className="flex flex-col-reverse lg:flex-row-reverse gap-4 lg:gap-6 h-full w-full relative font-sans text-slate-900 dark:text-white lg:p-3">
      ...
      <div className="w-full lg:w-80 flex flex-col gap-4 shrink-0 flex-1 min-h-0 lg:flex-none overflow-y-auto custom-scrollbar lg:pr-2 pb-4 lg:pb-0">
        ...
        <div className="bg-white/60 backdrop-blur-xl dark:bg-[#0d1117] border border-slate-200 dark:border-[#30363d] rounded-2xl p-5 shadow-sm shrink-0 mt-auto">
          <div className="flex-1 min-h-[120px] lg:min-h-[150px] bg-slate-50 dark:bg-black/90 border border-green-200 dark:border-[#30363d] rounded-xl flex flex-col overflow-hidden shadow-inner shrink-0">
            <div className="px-3 py-2 border-b border-green-200 dark:border-[#30363d] bg-green-100 dark:bg-[#161b22] flex items-center gap-2 shrink-0">
      ...
      <div className="h-[48vh] shrink-0 lg:h-auto lg:flex-1 bg-white/60 backdrop-blur-xl dark:bg-[#0d1117] border border-slate-200 dark:border-[#30363d] rounded-2xl p-4 sm:p-6 shadow-sm relative overflow-hidden flex flex-col">
        ...
        <div className="flex-1 min-h-0 border border-slate-200 dark:border-[#30363d] bg-white/60 backdrop-blur-xl/50 dark:bg-[#0a0c10] rounded-2xl relative flex flex-col shadow-inner overflow-hidden mb-2 lg:mb-4 items-center justify-center p-2 sm:p-4 lg:p-10 w-full shrink-0 min-h-[220px]">
        ...
        <AnimatePresence initial={false}>
          {showHUD && (
            ...
            >
              ...
              <div className="w-[130px] lg:w-[350px] shrink-0 border border-green-200 dark:border-[#30363d] bg-green-50 dark:bg-[#161b22] rounded-xl relative flex flex-col items-center justify-center shadow-inner h-full overflow-hidden">
          ...
          >
            ...
            >
              ...
              <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-2 flex items-center gap-2">
                <Activity className="text-emerald-500" /> Queue Visualizer
              </h3>
              ...
              <div className="space-y-4 text-sm text-slate-600 dark:text-slate-300 mt-4 h-max overflow-y-auto max-h-[60vh] custom-scrollbar pr-2">
                <p>
                  A <strong>Queue</strong> is a linear data structure that follows the First-In-First-Out (FIFO) principle. Elements are added at the rear and removed from the front.
                </p>
                <h4 className="font-bold text-slate-800 dark:text-slate-200 mt-4">Key Operations</h4>
                <p>
                  You can <strong>Enqueue</strong> (insert) elements at the rear or <strong>Dequeue</strong> (remove) elements from the front.
                </p>
              </div>
            </motion.div>
          </motion.div>
